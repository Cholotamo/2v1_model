...
np.save('M2_stage_1_features.npy', X_stage_1)
np.save('M2_stage_1_labels.npy', y_stage_1)
...
np.save('M2_stage_2_features.npy', X_stage_2)
np.save('M2_stage_2_labels.npy', y_stage_2)